...
En mai 2024, l'IGN a sorti sa nouvelle application "Cartes par IGN" sur mobile, avec enfin l'ambition de ["se frotter aux géants américains"](https://www.radiofrance.fr/franceinter/podcasts/l-info-de-france-inter/l-info-de-france-inter-6292950). Si les promesses ne sont pas encore toutes tenues (pas d'itinéraire vélo ni transport en commun, fonds de carte assez expert, pas de version Web), cette sortie pourrait marquer le début d'une reprise de souveraineté française.
