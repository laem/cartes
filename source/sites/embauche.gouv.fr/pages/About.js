			...
			<section className="ui__ container" id="about">
				...
				<section>
					...
					<p>
						...
						<em>
							module de simulation des sommes en jeu lors d&apos;une embauche
						</em>, peut être{' '}
				...
				<p>
					...
					l&apos;entreprise, etc.){' '}
					<em>ne sont pas stockées sur nos serveurs</em>.
				</p>
				<p>
					Par contre, nous recueillons des statistiques anonymes d&apos;usage du
					site, que nous utilisons dans l&apos;unique but d&apos;améliorer le
